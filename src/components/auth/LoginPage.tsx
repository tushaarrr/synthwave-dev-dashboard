...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="glass-dark rounded-2xl p-8 max-w-md w-full mx-4 animate-scale-in">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-gradient-to-r from-neon-blue to-neon-purple rounded-xl py-3 font-semibold hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3"
          >
