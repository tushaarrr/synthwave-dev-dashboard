...
const LoginPage = () => {
  ...
  const terminalLogs = [
    { text: "Initializing OneAI...", status: "loading" },
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex relative overflow-hidden">
      {/* Enhanced Background Animations WITHOUT Ring Circles */}
          ...
          <div className="text-center mb-8">
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-2 font-sora">
                {isLogin ? 'Welcome Back' : 'Join OneAI'}
              </h2>
          ...
          >
            ...
            <AnimatePresence>
              {error && (
                <motion.div
                  ...
                  className="bg-red-900/20 border border-red-800 rounded-xl p-4 mb-6 text-red-300 text-sm font-inter"
                >
                  {error}
                </motion.div>
              )}
            ...
            <div className="space-y-4 mb-6">
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-3 bg-zinc-700 border border-zinc-600 hover:bg-zinc-600 rounded-xl py-3 font-medium transition-all duration-200 disabled:opacity-50 group font-inter text-gray-200"
              >
                ...
                <span className="text-gray-200 font-inter">Continue with Google</span>
              </button>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-zinc-800 text-gray-400 font-inter">
                  or use your email
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleEmailAuth} className="space-y-5">
              ...
              >
                <span className="flex items-center justify-center gap-2">
                  {isLoading ? (
                    <>
                      <div className="w-5 h-5 border-2 border-zinc-700/30 border-t-zinc-700 rounded-full animate-spin"></div>
            ...
            <div className="text-center mt-6">
              <span className="text-gray-300 text-sm font-inter">
                {isLogin ? "New to OneAI? " : "Already have an account? "}
              </span>
              <button
                onClick={() => {
                  setIsLogin(!isLogin);
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-8 relative overflow-hidden bg-zinc-800">
        <motion.div 
        ...
        >
          ...
          {/* Terminal Mockup */}
          <motion.div 
            className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 text-left"
